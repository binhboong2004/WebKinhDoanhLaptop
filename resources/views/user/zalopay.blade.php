            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6 col-md-8">
                    <div class="checkout__order" style="border: 1px solid #e1e1e1; padding: 30px; border-radius: 5px;">
                        <h4 class="text-center">Quét mã QR ZaloPay để thanh toán</h4>
                        <p class="text-center">Vui lòng sử dụng App ZaloPay hoặc Zalo để quét mã.</p>
                        
                        <div class="text-center my-4">
                            <img src="{{ asset('user/img/zalopay-qr.png') }}" alt="Mã QR ZaloPay" style="max-width: 300px; border: 1px solid #ddd;">
                        </div>
